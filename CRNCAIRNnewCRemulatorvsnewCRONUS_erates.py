# -*- coding: utf-8 -*-
"""
Created on Wed Mar 02 10:50:10 2016
...
def CRNCAIRNnewCRemulatorvsnewCRONUS_erates():

    Dirname = "T://Papers_LaTeX//crn_basinwide_paper//Compiled_results//Brauch_vs_newCRONUS//"    
    ...
    plt.xlabel('$\epsilon_{CAIRN-CRCalc}$ (mm/kyr)', fontsize = axis_size)
    plt.ylabel('($\epsilon_{CRCalc}$-$\epsilon_{CAIRN-CRCalc}$)/$\epsilon_{CAIRN-CRCalc}$', fontsize = axis_size) 
    ...
    #plt.show()       
    Fileformat = "svg"
    plt.savefig(Dirname+"CAIRNnCemulator_vs_newCRONUS_erate_err.svg",format = Fileformat)
    
        

if __name__ == "__main__":
    CRNCAIRNnewCRemulatorvsnewCRONUS_erates()         
